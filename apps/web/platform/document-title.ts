 ...
 * `Issues | Super-Presales` and `Changelog | Super-Presales` can never drift
...
export const SITE_TITLE = "Super-Presales — Project Management for Human + Agent Teams";

/** Appended to every page-specific title. */
export const TITLE_SUFFIX = " | Super-Presales";
 ...
 * `MUL-123: Fix login` → `MUL-123: Fix login | Super-Presales`.
 *
 * An empty or whitespace-only name falls back to {@link SITE_TITLE} rather than
 * rendering a bare ` | Super-Presales`.
 */
